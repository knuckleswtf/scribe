...
> v2 is in alpha now! Try it out by changing your composer requirement to `^2.0.0-alpha`. See the [migration guide](https://scribe.readthedocs.io/en/v2/migrating-v2.html).
